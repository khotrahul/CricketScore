...
function loadScore(cc) {
	...
	//http://ifeed.vcricket.com/get_scorecardEX.aspx?sc=AU&sz=180x320&token=123456
	...
	s += '<img src="http://ifeed.vcricket.com/get_scorecardEX.aspx?sc=' + cc + '&sz=180x320&token=123456&T=' + time + '" width="200" height="320" border="0" alt="Live Score powered by vCricket.com">';
...
function schedule(){
	...
	s = '<img src="WC2011.png"  border="0" width="200" height="320" alt="WC 2011 Schedule">';
	$("score").innerHTML = s;	
}
})();
